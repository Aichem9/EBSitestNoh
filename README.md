...
교사가 과목과 정답 자료를 등록하면 학생이 답안을 제출하고 즉시 채점 결과와 오답 해설을 받는 Streamlit 앱입니다. 문제 PDF는 선택 사항입니다. 학생 제출 기록은 교사용 대시보드에서 분석하고 CSV로 내려받을 수 있습니다.
...
3. 정답 PDF를 올리고, 보유한 경우 문제 PDF와 해설 PDF도 함께 올립니다.
